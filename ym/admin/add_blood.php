...
<body>
    ...
    <div class="main">
        <div class="row">
            ...
            <form action="partials/_addBloodControl.php" class="bloodform" Style="width: 25rem; margin-bottom:10px; margin-right:40px" method="POST">
            <h4 style="color:red">Add Blood Record</h4>
