            ...
            <div class="profile-nav col-md-3">
                <div class="panel">
                    <div class="user-heading round">
                        ...
                        <li style="padding-right:10px;"><a  href="partials/_logout.php"><i class="fa fa-sign-out-alt"></i>Logout</a></li>
                ...
                <div class="panel">
                    <div class="panel-body bio-graph-info">
                        ...
                        <div class="row">
                            ...
                            <div class="bio-row">
                                <p><span>Pri. Mob. Num. </span>: <?php echo $row['pri_mob_number'];?></p>
                            </div>
                            <div class="bio-row">
                                <p><span>Sec. Mob. Num. </span>: <?php echo $row['sec_mob_number'];?></p>
                            </div>
                            <div class="bio-row">
                            ...
                            <div class="bio-row">
                                <p><span>Blood Group </span>: <?php echo $row['blood_group'];?></p>
                            </div>
                            <div class="bio-row">
                                <p><span>HB </span>: <?php echo $row['hb'];?></p>
                            </div>
                            <div class="bio-row">
                                <p><span>Weight </span>: <?php echo $row['weight'];?></p>
                            </div>
                            <div class="bio-row">
                                <p><span>Address </span>:
                                    <?php echo str_replace("%"," ",str_replace("_",",",$row['address']));?></p>
                            </div>
                            <div class="bio-row">
                            ...
                            <div class="bio-row">
                                <?php if($row['bloodDonor']=="yes"){ ?>
                                <p><span>Blood Donor </span>: Yes</p>

                                <?php
                             }
                            else{
                                echo '<p><span>Blood Donoe </span>: No</p>';
                            }?>
                            </div>
                            <div class="bio-row">
                                <?php if($row['plasmaDonor']=="yes"){ ?>
                                <p><span>Plasma Donor </span>: Yes</p>

                                <?php
                             }
                            else{
                                echo '<p><span>Plasma Donor </span>: No</p>';
                            }?>
                            </div>
                        </div>
                    </div>
