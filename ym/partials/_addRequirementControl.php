...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($numRows>0){
      header("location:/index.php?checkdetailsiscalled=true&&record=found");
    ...
    //to check email is alreadyy exists or not
            ...
            if($result){
               ...
               header("location:/index.php?requirementAddedSuccessfully=true&&alert=$showAlert");
            //    echo $showAlert;
            }
            ...
            // echo $showError;
           header("location: /index.php?requirementAddedSuccessfully=false&&error=$showError");
