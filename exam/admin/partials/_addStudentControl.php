...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($numRows>0){
      ...
      header("location: http://localhost/exam/admin/addStudent.php?studentAdded=false&&error=$showError");
    //   echo $showError;
            ...
            if($result){
                $showAlert=true;
               header("location: http://localhost/exam/admin/addStudent.php?StudentAdded=true");
            //    echo $showAlert;
            }
            else{
                echo("Error description: " . $conn -> error);
                header("location: http://localhost/exam/admin/addStudent.php?StudentAdded=false&&databaseSideError");
            }
