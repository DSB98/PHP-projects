...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($result){
      ...
      header("location: http://localhost/exam/admin/studentList.php?studentUpdated=true");
    //   echo $showError;

    }
    else{

        header("location: http://localhost/exam/admin/studentList.php?studentUpdated=false");
        }
