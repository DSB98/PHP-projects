                            ...
                            <div class="main">
                                <div class="row">
                                    <div class="col-md-10 col-11 mx-auto">
                                        <div class="card-body tab-content border-0" style="width:500px;">
                                            <h6>SECURITY</h6>
                                            <hr>
                                            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="Password" class="form-control" id="currentPass" name="currentPass" placeholder="your current password">
                                                    <br>
                                                    <input type="Password" class="form-control" id="newPass" name="newPass" placeholder="your new password">
                                                    <br>
                                                    <input type="Password" class="form-control" id="confirmPass" name="confirmPass" placeholder="confirm your new password">
                                                </div>
                                                <br>
    ...
    if ($numRows == 1) {
        ...
        if (password_verify($oldPass, $row['password'])) {
            ...
            if ($pass == $cpass) {
                ...
                $passSql = "UPDATE `user` SET password='$hash' WHERE  `user`.`user_id`=$user_id;";
                $result = mysqli_query($conn, $passSql);
                if ($result) {
                    // header("location:Password_change.html?passwordChanged=true");
                   // header("location:profile.php?PasswordHasBeenChangedSuccessfully");
                   $page = "profile.php?PasswordHasBeenChangedSuccessfully";
            echo '<script type="text/javascript">';
            echo 'window.location.href="' . $page . '";';
            echo '</script>';
                }
            } else {
               // header("location:profile.php?PasswordHasBeenChangedSuccessfully=False&&NewPasswordDoNotMatch");
            $page = "profile.php?PasswordHasBeenChanged=false&&passwordDoNotMatch";
            echo '<script type="text/javascript">';
            echo 'window.location.href="' . $page . '";';
            echo '</script>';
            }
            ...
            $wrongPass = true;
           // header("location:profile.php?PasswordHasBeenChangedSuccessfully=False&&OldPasswordIsincorrect");
            $page = "profile.php?PasswordHasBeenChanged=false&&OldPasswordIsWrong";
            echo '<script type="text/javascript">';
            echo 'window.location.href="' . $page . '";';
            echo '</script>';
        }
