    ...
    if($result){
        ...
        if($result){
            while($row=mysqli_fetch_assoc($result)){      
                ...
                header("location: /blood_bank/admin/add_blood.php?recordcreated=true&&stock=$quantity_updated&&alert=$showAlert");
            }
      ...
      header("location: /blood_bank/admin/add_blood.php?recordcreated=false&&error=$showError");
