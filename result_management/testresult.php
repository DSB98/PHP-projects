...
<body>
    ...
    ?>
            ...
            <div class="container table-respomsive">
                <div>
                    <img src="images/pdea.jpg" alt="" style="align-items: center; width:100px; height:100px; margin-left:auto; margin-right:auto;display:block;">
                    <h3 style="font-weight:700; text-align:center;">PDEA's Annasaheb Magar Mahavidyalaya</h3>
                    <p style="font-weight:600; text-align:center;">Hadapsar, Pune</p>
                    <p style="font-weight:600; text-align:center;">ARTS, COMMERCE, SCIENCE & COMPUTER</p>
                </div>
                ...
                <table calss="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Fail- A.T.K.T</td>
                           <?php } else{?>
                            <td><?php echo $rowTotal['total'] / $rowTotal['num'] ?>%</td>
                            <?php }?>
                        </tr>
                    </tbody>
