...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($numRows>0){
      ...
      header("location: http://localhost/result_management/admin/addExam.php?examAdded=false&&error=$showError");
    //   echo $showError;
            ...
            if($result){
                $showAlert=true;
               header("location: http://localhost/result_management/admin/addExam.php?examAdded=true");
            //    echo $showAlert;
            }
            else{
                echo("Error description: " . $conn -> error);
                header("location: http://localhost/result_management/admin/addExam.php?examAdded=false&&databaseSideError");
            }
